...
from CorpusAnalyses.analyse_hypotheses_proportions import analyse_always_0_or_7_proportion, analyse_always_decreases_proportion, analyse_nudge_proportion
