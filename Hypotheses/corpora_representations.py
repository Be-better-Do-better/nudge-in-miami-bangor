...
from CorpusAnalyses.corpus_analyses import get_cs_levels_distribution

def generate_utterances_corpora_representations(corpus: Corpus):
	...
	list_of_random_cs_series_of_with_utterances_distribution = \
		generate_random_list_of_series(get_cs_levels_distribution(corpus, utterances=True))
...
def generate_turns_corpora_representations(corpus: Corpus):
	...
	list_of_random_cs_series_of_with_turns_distribution = generate_random_list_of_series(
		get_cs_levels_distribution(corpus, utterances=False))
